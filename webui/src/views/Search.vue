  ...
  methods: {
    ...
    async getBanUsers() {
      ...
      try {
        ...
        console.log("banUsers: "+this.banUsers)
...
<div>
  ...
  <div class="card m-1" v-if="!loading">
    ...
    <div class="card-footer justify-content-between d-grid gap-2 d-md-block">
      ...
      <button type="button" class="btn btn-primary me-3" data-bs-toggle="modal" data-bs-target="#staticBackdropBan">Banned {{ banUsers.length }}</button>
